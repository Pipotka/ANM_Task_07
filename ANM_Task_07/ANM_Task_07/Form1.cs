...
namespace ANM_Task_07
{
	public partial class Form1 : Form
	{
        ...
        private void InitializeGame()
        {
            ...
            chickenImage = Properties.Resources.chicken;
            foxImage = Properties.Resources.fox;
        ...
        {
            var topChickens = chickens.Count(p => p.Y < 3);
            return topChickens >= 9;
        }

        private bool CheckFoxWin()
        {
            return chickens.Count <= 8;
        }
        ...
        private void UpdateBoard()
        {
            ...
            {
                if (grid[chicken.X, chicken.Y] != null)
                {
        ...
        private void GridButton_Click(object sender, EventArgs e)
        {
            ...
            if (isChickensTurn)
            {
                if (chickens.Contains(point))
                {
                    ...
                    {
                        // Перемещение курицы
                        if (GameBoard.IsValidMove(selectedChicken, point, chickens, foxes))
                        {
